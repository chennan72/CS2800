...
(check= (TriXOR (> 1 0) (> 1 1) (> 1 2)) t)
(check= (TriXOR t t t) nil)
(check= (TriXOR nil nil nil) nil)

(test? (implies (TriXOR t t nil) nil))#|ACL2s-ToDo-Line|#
...
(check= (how-many  1 '(3 2 1)) 1)
(check= (how-many  1 '(3 2 1 2 1)) 2)
;;(check= (how-many  1 '(1 2 '(1 2))) 1)
...
(defunc same-multiplicity (l l1 l2)
  ...
  :output-contract (booleanp (sam-multiplicity l l1 l2))
  (cond ((endp l) t)
        ((if (equal (how-many (first l) l1) (how-many (first l) l2))
           (and t (same-multiplicity (rest l) l1 l2))
           nil))))
